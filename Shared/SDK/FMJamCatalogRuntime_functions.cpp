...
int32 UFMJamSong::GetYear() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FMJamSong", "GetYear");
...
// (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const int32                             NumSongs                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
TArray<class UFMJamSong*> UFMJamSongCatalog::GetRandomSongList(const int32 NumSongs, const struct FGameplayTagQuery& TagQuery) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FMJamSongCatalog", "GetRandomSongList");
...
// (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const EFMJamSongCatalogSortMethod       SortMethod                                             (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const EFMJamSongCatalogSortDirection    SortDirection                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FGameplayTagQuery&         TagQuery                                               (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// TArray<class UFMJamSong*>               ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
...
TArray<class UFMJamSong*> UFMJamSongCatalog::GetSortedSongList(const EFMJamSongCatalogSortMethod SortMethod, const EFMJamSongCatalogSortDirection SortDirection, const struct FGameplayTagQuery& TagQuery) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FMJamSongCatalog", "GetSortedSongList");
