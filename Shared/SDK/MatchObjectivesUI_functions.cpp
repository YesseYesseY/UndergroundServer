...
void UFortMobileHUDElement_ObjectiveSelectorWrapper::HandleSkydiveModeChanged(ESkydiveFeedbackPhase Phase)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortMobileHUDElement_ObjectiveSelectorWrapper", "HandleSkydiveModeChanged");
...
bool AMatchObjectivesUIDirectorBase::IsAnyChallengeAvailable() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MatchObjectivesUIDirectorBase", "IsAnyChallengeAvailable");
...
// Parameters:
// const TArray<TScriptInterface<class IQuestDefinitionInterface>>&QuestOffering                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, UObjectWrapper, NativeAccessSpecifierPublic)
