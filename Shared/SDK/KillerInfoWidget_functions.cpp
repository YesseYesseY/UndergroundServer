...
void UKillerInfoWidget_C::SetKillerWeaponIconNameAndRarity(class UTexture2D* IconTexture, const class FText& ItemName, const EFortRarity ItemRarity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KillerInfoWidget_C", "SetKillerWeaponIconNameAndRarity");

	Params::KillerInfoWidget_C_SetKillerWeaponIconNameAndRarity Parms{};
