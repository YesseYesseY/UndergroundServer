...
class UEntityQueryManager* UDevices::_L_2fFortnite_2ecom_2fDevices_N_Roperator_U_2eGetQueryManagerFromObject_U_L_Ncreative__object__interface_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct Ftuple_Lcreative__object__interface_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("Devices", "_L_2fFortnite_2ecom_2fDevices_N_Roperator_U_2eGetQueryManagerFromObject_U_L_Ncreative__object__interface_M_Ntuple_L_R_M_Ntuple_L_R_R");
