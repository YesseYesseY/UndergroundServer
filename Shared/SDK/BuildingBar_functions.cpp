...
void UBuildingBar_C::Update_Max_HP_Value(double Max)
{
	static class UFunction* Func = nullptr;
...
void UBuildingBar_C::Update_Max_Durability_Value(double Max)
{
	static class UFunction* Func = nullptr;
...
void UBuildingBar_C::Update_Current_HP_Value(double Current)
{
	static class UFunction* Func = nullptr;
...
void UBuildingBar_C::Update_Current_Durability_Value(double CurrentDurability)
{
	static class UFunction* Func = nullptr;
...
// Function BuildingBar.BuildingBar_C.SetShowNumbersOnHealthBar
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    DoShow                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBuildingBar_C::SetShowNumbersOnHealthBar(bool DoShow)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingBar_C", "SetShowNumbersOnHealthBar");

	Params::BuildingBar_C_SetShowNumbersOnHealthBar Parms{};
...
// Function BuildingBar.BuildingBar_C.SetHealthBarSize
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBuildingBar_C::SetHealthBarSize(const struct FVector2D& Size)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingBar_C", "SetHealthBarSize");

	Params::BuildingBar_C_SetHealthBarSize Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FText&                      HP_Text                                                (BlueprintVisible, BlueprintReadOnly, Parm)
...
void UBuildingBar_C::SetBigHealthPercentFill(double Percent)
{
	static class UFunction* Func = nullptr;
