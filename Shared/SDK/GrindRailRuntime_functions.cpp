...
// const struct FVector&                   PawnLocation                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   StartDistance                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FVector&                   LastUpdateVelocity                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// const struct FVector&                   CurrentDirection                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGrindingRequestCalculationData UFortPawnComponent_GrindingProvider::BP_HandleGrindStartRequestData(class AFortGrindRail* GrindRail, const struct FVector& PawnLocation, float StartDistance, const struct FVector& LastUpdateVelocity, bool bIsGrinding, bool bStartedFromLand, float CurrentSpeedAlongSpline, const struct FVector& CurrentDirection)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_GrindingProvider", "BP_HandleGrindStartRequestData");
