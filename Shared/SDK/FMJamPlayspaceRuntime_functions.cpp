...
// (Final, Native, Protected)
// Parameters:
// const struct FJamLoadResult&            LoadResult                                             (ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
// Parameters:
// const struct FJamPlayParams&            OldPlayParams                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
const class USparksJamEmoteItemDefinition* UJamMusicSlot::GetItemDef() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamMusicSlot", "GetItemDef");
...
// (Final, Native, Public, HasOutParams)
// Parameters:
// const struct FJamPlayParams&            PlayParams                                             (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
const struct FJamEvent_JamLoopStarted UJamPlayspaceComponent_MusicManager::GetJamInfoFromSlot(int32 SlotIndex) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspaceComponent_MusicManager", "GetJamInfoFromSlot");
