...
void USparksBaseLayerAnimInstance::OnInstrumentPSCInitialized(class USparksInstrumentAnimPlayerStateComponent* NewInstrumentPSC)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SparksBaseLayerAnimInstance", "OnInstrumentPSCInitialized");
...
void USparksInstrumentAnimInstance::SetMidiEventDriver(TScriptInterface<class IMidiEventDriverInterface> NewMidiEventDriver)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SparksInstrumentAnimInstance", "SetMidiEventDriver");
...
TScriptInterface<class IMidiEventDriverInterface> USparksInstrumentAnimInstance::GetMidiEventDriver() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SparksInstrumentAnimInstance", "GetMidiEventDriver");
