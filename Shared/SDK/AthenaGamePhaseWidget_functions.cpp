...
void UAthenaGamePhaseWidget_C::OnUpdateGamePhaseIcon(EAthenaGamePhaseStep GamePhaseStep)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaGamePhaseWidget_C", "OnUpdateGamePhaseIcon");

	Params::AthenaGamePhaseWidget_C_OnUpdateGamePhaseIcon Parms{};
