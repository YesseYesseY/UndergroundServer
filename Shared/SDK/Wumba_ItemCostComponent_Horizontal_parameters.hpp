...
public:
	...
	class AB_Athena_Wumba_C*                      K2Node_DynamicCast_AsB_Athena_Wumba;               // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Wumba_ItemCostComponent_Horizontal_C_GetCost;
