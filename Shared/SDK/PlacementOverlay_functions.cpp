...
// Function PlacementOverlay.PlacementOverlay_C.Show Win
// (BlueprintCallable, BlueprintEvent)

void UPlacementOverlay_C::Show_Win()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlacementOverlay_C", "Show Win");

	UObject::ProcessEvent(Func, nullptr);
}


// Function PlacementOverlay.PlacementOverlay_C.Show Tie
// (BlueprintCallable, BlueprintEvent)

void UPlacementOverlay_C::Show_Tie()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlacementOverlay_C", "Show Tie");

	UObject::ProcessEvent(Func, nullptr);
}


// Function PlacementOverlay.PlacementOverlay_C.Show Loss
// (BlueprintCallable, BlueprintEvent)

void UPlacementOverlay_C::Show_Loss()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlacementOverlay_C", "Show Loss");
