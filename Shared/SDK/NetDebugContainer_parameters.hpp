...
DUMPER7_ASSERTS_NetDebugContainer_C_OnVisibilitySetEvent;
...
public:
	...
	ESlateVisibility                              K2Node_Event_InVisibility;                         // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x0006(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NetDebugContainer_C_ExecuteUbergraph_NetDebugContainer;
