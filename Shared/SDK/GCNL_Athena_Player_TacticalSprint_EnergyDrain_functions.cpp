...
void AGCNL_Athena_Player_TacticalSprint_EnergyDrain_C::ExecuteUbergraph_GCNL_Athena_Player_TacticalSprint_EnergyDrain(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Player_TacticalSprint_EnergyDrain_C", "ExecuteUbergraph_GCNL_Athena_Player_TacticalSprint_EnergyDrain");
...
void AGCNL_Athena_Player_TacticalSprint_EnergyDrain_C::OnLoopingStartGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Player_TacticalSprint_EnergyDrain_C", "OnLoopingStartGeneric");
...
void AGCNL_Athena_Player_TacticalSprint_EnergyDrain_C::OnRemovalGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Player_TacticalSprint_EnergyDrain_C", "OnRemovalGeneric");
...
void AGCNL_Athena_Player_TacticalSprint_EnergyDrain_C::UpdateFX()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Player_TacticalSprint_EnergyDrain_C", "UpdateFX");
