...
{
public:
	class AFortPlayerController*                  Requesting_Player_Controller;                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortCreativeIslandLink*                Link;                                              // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          _;                                                 // 0x0010(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_MatchmakingInterface_C_SendIslandLink;
...
DUMPER7_ASSERTS_MatchmakingInterface_C_MatchmakingPortalHasSecondInteraction;
...
DUMPER7_ASSERTS_MatchmakingInterface_C_AthenaInteractDetails;
