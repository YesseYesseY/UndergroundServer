...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MoverBasePawn")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MoverBasePawn")
	}
...
DUMPER7_ASSERTS_AMoverBasePawn;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovementBaseUtils")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovementBaseUtils")
	}
...
DUMPER7_ASSERTS_UMovementBaseUtils;
...
public:
	...
	TMulticastInlineDelegate<void(const struct FMoverTimeStep& TimeStep)> OnPostSimulationTick;      // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FMoverTimeStep& CurrentTimeStep, const struct FMoverTimeStep& ExpungedTimeStep)> OnPostSimulationRollback; // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FMoverOnImpactParams& ImpactParams)> OnImpact;        // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
