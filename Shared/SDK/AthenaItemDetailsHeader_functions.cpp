...
// bool                                    IsZeroDisplayed                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaItemDetailsHeader_C::UpdateQuantityText(int32 Count, bool IsZeroDisplayed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaItemDetailsHeader_C", "UpdateQuantityText");

	Params::AthenaItemDetailsHeader_C_UpdateQuantityText Parms{};

	Parms.Count = Count;
	Parms.IsZeroDisplayed = IsZeroDisplayed;
...
// class UFortWeaponItemDefinition**       WeaponItemDef                                          (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UAthenaItemDetailsHeader_C::TryGetWeaponItemDefForItem(class UFortItem* Item, class UFortWeaponItemDefinition** WeaponItemDef)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaItemDetailsHeader_C", "TryGetWeaponItemDefForItem");

	Params::AthenaItemDetailsHeader_C_TryGetWeaponItemDefForItem Parms{};
	...
	if (WeaponItemDef != nullptr)
		*WeaponItemDef = Parms.WeaponItemDef;
}
