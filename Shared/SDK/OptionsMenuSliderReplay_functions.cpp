...
// Parameters:
// double                                  UnmappedValue                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UOptionsMenuSliderReplay_C::UpdateSliderValueUnmapped(double UnmappedValue)
{
...
void UOptionsMenuSliderReplay_C::Update_Slider_Value(double NormalizedValue)
{
	static class UFunction* Func = nullptr;
...
// class UCommonTextBlock*                 Tooltip_Text_Block                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// const struct FVector2D&                 Min_Max_Value                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UOptionsMenuSliderReplay_C::Update_Slider(const class FText& Slider_Text, double Slider_Value, const class FText& Hover_Text_0, class UCommonTextBlock* Tooltip_Text_Block, const struct FVector2D& Min_Max_Value)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenuSliderReplay_C::GetSliderValueText(double Value, class FText* ValueText)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// double*                                 MappedValue                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UOptionsMenuSliderReplay_C::GetMappedValue(double* MappedValue)
{
	static class UFunction* Func = nullptr;
