...
// Function Tiered_Chest_Athena.Tiered_Chest_Athena_C.SwapChestVFX
// (BlueprintCallable, BlueprintEvent)

void ATiered_Chest_Athena_C::SwapChestVFX()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "SwapChestVFX");

	UObject::ProcessEvent(Func, nullptr);
}


// Function Tiered_Chest_Athena.Tiered_Chest_Athena_C.SwapChestAV
// (BlueprintCallable, BlueprintEvent)

void ATiered_Chest_Athena_C::SwapChestAV()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "SwapChestAV");
...
// Parameters:
// bool*                                   Rare_Chest                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATiered_Chest_Athena_C::IsRareChest(bool* Rare_Chest)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "IsRareChest");

	Params::Tiered_Chest_Athena_C_IsRareChest Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Rare_Chest != nullptr)
		*Rare_Chest = Parms.Rare_Chest;
}
...
void ATiered_Chest_Athena_C::GetMaxAudibleDistance(double* Max_Distance)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// EContainerEventTypes*                   Container_Type                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATiered_Chest_Athena_C::Get_Chest_Type(EContainerEventTypes* Container_Type)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "Get Chest Type");

	Params::Tiered_Chest_Athena_C_Get_Chest_Type Parms{};
...
void ATiered_Chest_Athena_C::FX_Glow___Smoke_Sheet_Setup()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "FX Glow & Smoke Sheet Setup");
