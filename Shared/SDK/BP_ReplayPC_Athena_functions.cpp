...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Playback_Multiplier                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_ReplayPC_Athena_C::_Speedup_Loops(double Playback_Multiplier)
{
	static class UFunction* Func = nullptr;
