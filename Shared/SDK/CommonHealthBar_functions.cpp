...
void UCommonHealthBar_C::Update_Max_HP_Value(double Max)
{
...
void UCommonHealthBar_C::Update_Current_HP_Value(double Current)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    DoShow                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCommonHealthBar_C::SetShowNumbers(bool DoShow)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonHealthBar_C", "SetShowNumbers");

	Params::CommonHealthBar_C_SetShowNumbers Parms{};
...
void UCommonHealthBar_C::SetHealthSize(const struct FVector2D& NewSize)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonHealthBar_C", "SetHealthSize");

	Params::CommonHealthBar_C_SetHealthSize Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FLinearColor&              Color_A                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FLinearColor&              Color_B                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FLinearColor&              Baseplate_Color                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
