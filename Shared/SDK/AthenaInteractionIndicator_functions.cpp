...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  SecondsToInterpolate                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaInteractionIndicator_C::Update_Keybind_Custom_Progress(double SecondsToInterpolate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaInteractionIndicator_C", "Update Keybind Custom Progress");

	Params::AthenaInteractionIndicator_C_Update_Keybind_Custom_Progress Parms{};

	Parms.SecondsToInterpolate = SecondsToInterpolate;
...
// Parameters:
// class AB_Athena_Wumba_C*&               WUMBA_Ref                                              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class AActor*&                          Portal                                                 (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    UseCustomProgress                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UKeybindWidget_C*                 KeybindWidget_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// double                                  SecondsToInterpolate                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    ChangedTarget                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaInteractionIndicator_C::SetKeybindCustomProgress(bool UseCustomProgress, class UKeybindWidget_C* KeybindWidget_0, double SecondsToInterpolate, bool ChangedTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaInteractionIndicator_C", "SetKeybindCustomProgress");

	Params::AthenaInteractionIndicator_C_SetKeybindCustomProgress Parms{};

	Parms.UseCustomProgress = UseCustomProgress;
	Parms.KeybindWidget_0 = KeybindWidget_0;
	Parms.SecondsToInterpolate = SecondsToInterpolate;
	Parms.ChangedTarget = ChangedTarget;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortInteractContextInfo*         CurrentInteraction_0                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortItemWidget_NUI*              Widget                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
