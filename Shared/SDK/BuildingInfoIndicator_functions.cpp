...
// class UKeybindWidgetDark_C*             KeyBind                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UBuildingInfoIndicator_C::UpdateFromTargetingDataOverride()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "UpdateFromTargetingDataOverride");
...
void UBuildingInfoIndicator_C::OnSavedEventStateExists_7EF7B869407017EB4834F0BFF510995D(class UAsyncAction_StartListeningToStatefulEvent* ProxyObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "OnSavedEventStateExists_7EF7B869407017EB4834F0BFF510995D");

	Params::BuildingInfoIndicator_C_OnSavedEventStateExists_7EF7B869407017EB4834F0BFF510995D Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class UFocusedBuildingDynamicData*DynamicData                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBuildingInfoIndicator_C::OnFocusedBuildingDynamicDataReceived(const class UFocusedBuildingDynamicData* DynamicData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "OnFocusedBuildingDynamicDataReceived");

	Params::BuildingInfoIndicator_C_OnFocusedBuildingDynamicDataReceived Parms{};
...
void UBuildingInfoIndicator_C::OnEventStateCleared_7EF7B869407017EB4834F0BFF510995D(class UAsyncAction_StartListeningToStatefulEvent* ProxyObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "OnEventStateCleared_7EF7B869407017EB4834F0BFF510995D");

	Params::BuildingInfoIndicator_C_OnEventStateCleared_7EF7B869407017EB4834F0BFF510995D Parms{};
...
void UBuildingInfoIndicator_C::OnEventReceived_7EF7B869407017EB4834F0BFF510995D(class UAsyncAction_StartListeningToStatefulEvent* ProxyObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "OnEventReceived_7EF7B869407017EB4834F0BFF510995D");

	Params::BuildingInfoIndicator_C_OnEventReceived_7EF7B869407017EB4834F0BFF510995D Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const EAthenaGamePhaseStep              NewPhase                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBuildingInfoIndicator_C::HandleGamePhaseChanged(const EAthenaGamePhaseStep NewPhase)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "HandleGamePhaseChanged");

	Params::BuildingInfoIndicator_C_HandleGamePhaseChanged Parms{};
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABuildingActor*                   FocusedBuilding                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FText&                      HP_Value                                               (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABuildingTrap*                    BuildingTrap                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// Function BuildingInfoIndicator.BuildingInfoIndicator_C.Destruct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UBuildingInfoIndicator_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingInfoIndicator_C", "Destruct");
...
// Parameters:
// const struct FFortFocusedBuildingInfo&  FocusedBuildingInfo                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
