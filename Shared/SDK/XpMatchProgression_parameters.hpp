...
DUMPER7_ASSERTS_XpMatchProgression_C_UpdateRewardForLevel;
...
DUMPER7_ASSERTS_XpMatchProgression_C_TickRewardAnimation;
...
DUMPER7_ASSERTS_XpMatchProgression_C_Tick;
...
DUMPER7_ASSERTS_XpMatchProgression_C_SetPlayerState;
...
{
public:
	class UAthenaPlayerMatchReport*               Report_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_XpMatchProgression_C_Play_Xp_Rewards;
...
DUMPER7_ASSERTS_XpMatchProgression_C_IsReadyForNextXpEvent;
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAthenaPlayerMatchReport*               K2Node_CustomEvent_Report;                         // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_InterpolateToValue_TargetValue_ImplicitCast; // 0x0080(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_InterpolateToValue_TargetValue_ImplicitCast_1; // 0x0084(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression;
...
DUMPER7_ASSERTS_XpMatchProgression_C_BndEvt__PlayerLevelBar_K2Node_ComponentBoundEvent_3_LevelChanged__DelegateSignature;
