...
// Parameters:
// const TMap<EFortResourceType, int32>&   Costs                                                  (BlueprintVisible, BlueprintReadOnly, Parm)
// class UResourceCountWidget_C*           ResourceWidget                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UClass*                           SpecifiedItemCostComponent                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// const TMap<EFortResourceType, int32>&   Costs                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const EFortResourceType&                Resource                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UResourceCountWidget_C**          Widget                                                 (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
