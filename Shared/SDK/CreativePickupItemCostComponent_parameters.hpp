...
public:
	...
	class AFortPickupCreative*                    K2Node_DynamicCast_AsFort_Pickup_Creative;         // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_CreativePickupItemCostComponent_C_GetCost;
